...
public class InconsistentDataException extends RuntimeException {
	...
	public InconsistentDataException(String resourceName, String fieldName, String fieldValue) {
		super(String.format("Datos inconsistentes en actualización de %s con %s  '%s' .", resourceName, fieldName,
				fieldValue));
